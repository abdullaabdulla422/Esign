...
public class ReceiveCheckIn extends AppCompatActivity {
    ...
    int hr,checkin;
    ArrayList<String> mylabel;
    String label;
    ArrayList<Integer> spinn;
    ...
    //    TextView txt_make, txt_model, txt_serialNo, txt_unitId, txt_currentBranch, txt_transferBranch, txt_CustomerBranch;
//    TextView lbl_txt_make, lbl_txt_model, lbl_txt_serialNo, lbl_txt_unitId, lbl_txt_currentBranch,
//            lbl_txt_transferBranch, lbl_txt_CustomerBranch;
    // TransferEquipmentSearchObject transferEquipmentSearchObject;
    TransferReceiveEquipmentSearchObject ReceiveEquipmentSearchObject;
    TextView make, model, serialNo, UnitID, TransferedBranch;

    EditText hourMeter;

    TextView CurrentBranch;
    ...
    public static final String IMAGE_DIRECTORY_NAME = "rental_data/Camera";
    ...
    EquipmentCheckParts checkparts;
    ArrayList<String> cheklistArray;
    ArrayList<CheckinListData> notes;
    //TextView txtTitle;
    ...
    TextView lbl_Make, lbl_Model, lbl_SerialNo, lbl_UnitId, lbl_TransferedBranch, lbl_CurrentBranch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.receive_checklist);
...
//        lbl_txt_CustomerBranch = (TextView)findViewById(R.id.lbl_customerbranch);
        ...
        lbl_Make = (TextView)findViewById(R.id.lbl_make);
        lbl_Model = (TextView)findViewById(R.id.lbl_model);
        lbl_SerialNo = (TextView)findViewById(R.id.lbl_serial_no);
        lbl_UnitId = (TextView)findViewById(R.id.lbl_unitid);
        lbl_TransferedBranch = (TextView)findViewById(R.id.lbl_transferedbranch);
        lbl_CurrentBranch = (TextView)findViewById(R.id.lbl_currentbranch);
...
//        }
    ...
    public class Asyncequpment extends AsyncTask<Void, Void, Void> {

        protected void onPreExecute() {
            ProgressBar.showCommonProgressDialog(ReceiveCheckIn.this);
        };
        ...
        protected void onPostExecute(Void result) {
            if(SessionData.getInstance().getEqupmentSubStatusResult()==1){
                ...
                if(equpsubStatus.getMessage().contains("Session")){
                    ...
                    dialog = new Dialog(ReceiveCheckIn.this);
...
//				requestWindowFeature(Window.FEATURE_NO_TITLE);
                    ...
                    yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent inspection = new Intent(ReceiveCheckIn.this,
                                    MainActivity.class);
    ...
    public class Asyncequpmentdec extends AsyncTask<Void, Void, Void> {
...
//				requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public class Asyncequpments extends AsyncTask<Void, Void, Void> {
...
//				requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public class AsyncSessionLoginTask_Receive extends AsyncTask<Void, Void, Void> {
...
//				requestWindowFeature(Window.FEATURE_NO_TITLE);
                ...
                ProgressBar.dismiss();
                AlertDialogBox.showAlertDialog(ReceiveCheckIn.this,
                        "Data is not found");
    ...
    public void initializeViews(ArrayList<CheckList> check) {
        ...
        if ((checkList.size() == 1)) {
            ...
            //TextView make, model, serialNo, UnitID, TransferedBranch;
            //lbl_Make, lbl_Model, lbl_SerialNo, lbl_UnitId, lbl_TransferedBranch;

            lbl_Make.setVisibility(View.VISIBLE);
            lbl_Model.setVisibility(View.VISIBLE);
            lbl_SerialNo.setVisibility(View.VISIBLE);
            lbl_UnitId.setVisibility(View.VISIBLE);
            lbl_TransferedBranch.setVisibility(View.VISIBLE);
            lbl_CurrentBranch.setVisibility(View.VISIBLE);
            CurrentBranch.setVisibility(View.VISIBLE);

            make.setVisibility(View.VISIBLE);
            model.setVisibility(View.VISIBLE);
            serialNo.setVisibility(View.VISIBLE);
            UnitID.setVisibility(View.VISIBLE);
            TransferedBranch.setVisibility(View.VISIBLE);
...
//		}
        ...
        if(SessionData.getInstance().getPrevioushours().equals("0")){
            hourMeter.setText("" + ReceiveEquipmentSearchObject.getHourmeter());
            previoushours = ReceiveEquipmentSearchObject.getHourmeter();
        }else{
        ...
        Log.d("status",""+statusforeqp);
        dueStatus = (ReceiveEquipmentSearchObject
                .getEquipstatus());

        list1.add(dueStatus);
        if (!dueStatus.equals("ON")) {
            list1.add("ON");
        }
        if (!dueStatus.equals("MA")) {
            list1.add("MA");
        }
        if (!dueStatus.equals("PI")) {
            list1.add("PI");
        }
        ...
        eqpStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                SessionData.getInstance().setResieveSelectedStatus(statusselect);
...
//        pmSpc = (ReceiveEquipmentSearchObject
//                .get);

//        emeter = (ReceiveEquipmentSearchObject
//                .get);
//        ereading = (ReceiveEquipmentSearchObject
//                .get);
...
//
        ...
        substatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg,
                ...
                SessionData.getInstance().setReceiveSelectedSubStatus(equpst);
...
//
        ...
        if (i >= 0 && i < (checkList.size() - 1)) {
            if (i == 0) {
                ...
                Substatusdec.setVisibility(View.GONE);
                Equpstatus.setVisibility(View.GONE);
                lbl_Make.setVisibility(View.GONE);
                lbl_Model.setVisibility(View.GONE);
                lbl_SerialNo.setVisibility(View.GONE);
                lbl_UnitId.setVisibility(View.GONE);
                lbl_TransferedBranch.setVisibility(View.GONE);
                lbl_CurrentBranch.setVisibility(View.GONE);
                CurrentBranch.setVisibility(View.GONE);

                make.setVisibility(View.GONE);
                model.setVisibility(View.GONE);
                serialNo.setVisibility(View.GONE);
                UnitID.setVisibility(View.GONE);
                TransferedBranch.setVisibility(View.GONE);
...
//                    Log.d("hr", ""+ hr);
                ...
                Intent in = new Intent(ReceiveCheckIn.this,ReceiveSummary.class);
                startActivity(in);
        ...
        if (RESULT_CODE == CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(ReceiveCheckIn.this,
