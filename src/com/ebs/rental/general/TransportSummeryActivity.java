...
public class TransportSummeryActivity extends AppCompatActivity {
    private double dpi;
    ...
    private ArrayList<CustomerNameMail> customeremails = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transportation_summary_checklist_2);
...
//					drop_down_img.setBackgroundResource();
...
//					drop_down_img.setBackgroundResource(R.drawable.arrow_down_down);
                }

            }
        });

        txtTitle.setText("Transport Summary");
                ...
                if (SessionData.getInstance().getIssign() == false) {
                    ...
                    if(SessionData.getInstance().getTransportTransfer()==1){
                        if((TransportListIndex+1)==Kequipnu.size()){
                            Intent intent = new Intent(TransportSummeryActivity.this,
...
//				dialog.dismiss();
        ...
        txtCheckList.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sadap = new Summaryadapter(TransportSummeryActivity.this, summarydesc);
        ...
        txtWalkAround.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                summaryWalkadapter = new SummaryWalkadapter(TransportSummeryActivity.this, Notes);
...
//	}
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        final Dialog dialog = new Dialog(TransportSummeryActivity.this);
...
//                        }
    ...
    private class Asynterms extends AsyncTask<Void, Void, Void> {
        protected void onPreExecute() {
            ...
            ProgressBar.showCommonProgressDialog(TransportSummeryActivity.this);
        };
            ...
            if (orderTerms != null && !(orderTerms.equals("")) ) {
                ...
                if(SessionData.getInstance().getRentalChecklistPDFResult()==1){
                    ...
                    if(orderTerms.getMessage().contains("Session")){
                        ...
                        dialog = new Dialog(TransportSummeryActivity.this);
                        dialog.setCanceledOnTouchOutside(true);
                        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
...
//								startActivity(inspection);
                    ...
                    if((TransportListIndex+1)==Kequipnu.size()){
                        Intent intent = new Intent(TransportSummeryActivity.this,
                                TransportTearmsAndConditions.class);
                        startActivity(intent);
                        finish();
                    }else{
                ...
                ProgressBar.dismiss();
                AlertDialogBox.showAlertDialog(TransportSummeryActivity.this,
                        "Data is not found.");
...
//            } else {
            ...
            if (SessionData.getInstance().getRentalCheckinResult() == 1) {
                ...
                Toast.makeText(TransportSummeryActivity.this,
...
//				requestWindowFeature(Window.FEATURE_NO_TITLE);
                    ...
                    yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent inspection = new Intent(TransportSummeryActivity.this,
                                    MainActivity.class);
                            startActivity(inspection);
                            dialog.dismiss();
                        }
...
//					}
    ...
    public void summary(Activity activity) {
        ...
        Summaryadapter sadap = new Summaryadapter(TransportSummeryActivity.this,
                summarydesc);
        li.setAdapter(sadap);
        li.clearChoices();
        sadap.notifyDataSetChanged();
