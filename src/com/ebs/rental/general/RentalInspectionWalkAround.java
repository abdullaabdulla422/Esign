...
public class RentalInspectionWalkAround extends AppCompatActivity implements View.OnClickListener {
    ...
    private MaterialRippleLayout rippleAvailBtn;
    private int countp;
...
//	initializeViews(checkList);
        ...
        lnr_spot = (LinearLayout) findViewById(R.id.lnr_spot);
        lnr_section.setVisibility(View.VISIBLE);
        lnr_spot.setVisibility(View.VISIBLE);


        btn_availableParking = (Button) findViewById(R.id.btn_available_parking);
        rippleAvailBtn = (MaterialRippleLayout) findViewById(R.id.ripple_avail_btn);
        ...
        txtEquipID.setText(SessionData.getInstance().getKpartlist().get(j));
...
//        new AsyncType().execute();
        ...
        gallery.setAdapter(new ImageAdapter(RentalInspectionWalkAround.this));

        gallery.setOnItemClickListener(new AdapterView.OnItemClickListener() {


            public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
                Image_dialog = new Dialog(RentalInspectionWalkAround.this);
                ...
                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(RentalInspectionWalkAround.this,
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (SelectType.getSelectedItemPosition() == 0) {
                            ...
                            Toast.makeText(RentalInspectionWalkAround.this, "Select type", Toast.LENGTH_LONG).show();

                        } else if (notes.getText().toString().trim().length() == 0) {
                            Toast.makeText(RentalInspectionWalkAround.this, "Enter Notes", Toast.LENGTH_LONG).show();
                        } else {
                            String str;
...
//
        ...
        if (SessionData.getInstance().getRentalIn_Out() == "I") {
            rippleAvailBtn.setVisibility(View.VISIBLE);
        } else if (SessionData.getInstance().getRentalIn_Out() == "O") {
            rippleAvailBtn.setVisibility(View.GONE);
        }
    }
    ...
    private void getGps() {
        gps = new GPSTracker(RentalInspectionWalkAround.this);
        if (gps.canGetLocation()) {
            latitude = gps.getLatitude();
            longitude = gps.getLongitude();
            SessionData.getInstance().setLatitude(latitude);
            SessionData.getInstance().setLongitude(longitude);
            Intent inspection = new Intent(RentalInspectionWalkAround.this, WalkAroundCamera.class);
...
//
//            Intent inspection = new Intent(RentalInspectionWalkAround.this, TransportListDetails.class);
//            startActivity(inspection);
//        }else{
...
//        }
    ...
    public void onClick(View v) {
        if (next == v) {
            ...
            Intent inspection = new Intent(RentalInspectionWalkAround.this, CustomizedPartsCheck.class);
            startActivity(inspection);
        } else if (imgback == v) {
...
//            Intent inspection = new Intent(RentalInspectionWalkAround.this, RentalListSelector.class);
//            startActivity(inspection);
        } else if (txtback == v) {
...
//            startActivity(inspection);
            ...
            try {
                ...
                Toast.makeText(RentalInspectionWalkAround.this, "Sorry! Your device doesn\\'t support speech input ", Toast.LENGTH_SHORT).show();
            }
    ...
    private class AsyncRentalDetail extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ProgressBar.showCommonProgressDialog(RentalInspectionWalkAround.this);
        }
        ...
        protected void onPostExecute(Void result) {
            if (detail != null && detail.size() > 0) {
                ...
                if (detail.get(0).getMessage().equals("")) {
                    ...
                    Intent intent = new Intent(RentalInspectionWalkAround.this,
                    ...
                    if (detail.get(0).getMessage().contains("Session")) {
                        ...
                        dialog = new Dialog(RentalInspectionWalkAround.this);
...
//				requestWindowFeature(Window.FEATURE_NO_TITLE);
                        ...
                        yes.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent inspection = new Intent(RentalInspectionWalkAround.this,
                                        MainActivity.class);
                                startActivity(inspection);
                                dialog.dismiss();
                            }
                ...
                ProgressBar.dismiss();
                AlertDialogBox.showAlertDialog(RentalInspectionWalkAround.this,
...
//            holder.txtSpot.setText(generalEquipment.getSpot());
    ...
    public class AvailableAdapter extends BaseAdapter {
        ...
        @Override
        public View getView(int position, View convertView, ViewGroup parent) {
            RentalInspectionWalkAround.AvailableAdapter.ViewHolder holder;
            if (convertView == null) {
                holder = new RentalInspectionWalkAround.AvailableAdapter.ViewHolder();
                convertView = LayoutInflater.from(mContext).inflate(R.layout.child_available_list, null);
                holder.txtSection = (TextView) convertView.findViewById(R.id.txt_avail_section);
                holder.txtSpot = (TextView) convertView.findViewById(R.id.txt_avail_spot);
                convertView.setFocusable(false);
                ...
                holder = (RentalInspectionWalkAround.AvailableAdapter.ViewHolder) convertView.getTag();
            }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (parkingList.get(0).getMessage().contains("Session")) {
                ...
                if (parkingList != null && (parkingList.size() > 0)) {
                    final Dialog dialog = new Dialog(RentalInspectionWalkAround.this);
                    ...
                    availableAdapter = new AvailableAdapter(RentalInspectionWalkAround.this, parkingList);
