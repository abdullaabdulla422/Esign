...
public class GeneralInspectionDetails {
    ...
    public static ArrayList<GeneralInspectionDetails> parseData(String response) throws Exception{

        ArrayList<GeneralInspectionDetails> rental = new ArrayList<>();

        GeneralInspectionDetails detail =  new GeneralInspectionDetails();

        JSONArray detailarray = new JSONArray();
        detailarray = new JSONArray(response);

        for (int i = 0; i < detailarray.length(); i++) {
            detail =  new GeneralInspectionDetails();
