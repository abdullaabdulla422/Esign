...
public class PartsOrderCustomer extends AppCompatActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.parts_customer_list);
		...
		adap = new customerAdapter(PartsOrderCustomer.this, orderCustlist);
		list = (ListView) findViewById(R.id.partscustlist);
	...
	private class AsycOrderLists extends AsyncTask<Void, Void, Void> {
		protected void onPreExecute() {
			ProgressBar.showCommonProgressDialog(PartsOrderCustomer.this);
		};
		...
		protected Void doInBackground(Void... arg0) {
			try {
				orderLists = WebServiceConsumer.getInstance()
						.getPartorderList(user.getUserDescription(),
		...
		protected void onPostExecute(Void result) {
			...
			if (orderLists != null && orderLists.size() > 0) {
				...
				if(orderLists.get(0).getMessage().equals("")){
					...
					Intent intent = new Intent(PartsOrderCustomer.this,
					...
					if(orderLists.get(0).getMessage().contains("Session")){
						...
						dialog = new Dialog(PartsOrderCustomer.this);
...
//				requestWindowFeature(Window.FEATURE_NO_TITLE);
						...
						yes.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View v) {
								...
								Intent inspection = new Intent(PartsOrderCustomer.this,
										MainActivity.class);
				...
				ProgressBar.dismiss();
				AlertDialogBox.showAlertDialog(PartsOrderCustomer.this,
						"Data is not found.");
			}
		}
