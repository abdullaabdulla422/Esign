...
public class RentalPartsOrderBranch extends AppCompatActivity implements OnClickListener {
	...
	private User user;
	ArrayList<DealerBranches> deacount;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rental_parts_order_branch);
		...
		thumbnailsselection = new boolean[countp];
		// adapter = new ArrayAdapter<String>(this, R.layout.dealer_row,
		// R.id.branchrow);
		// list.setAdapter(adapter);
		adap = new DealerAdapter(RentalPartsOrderBranch.this, dealer);
		inputSearch = (EditText) findViewById(R.id.partsinputSearch);
		mlist = (Button) findViewById(R.id.morelist);
		mlist.setOnClickListener(this);
		list = (ListView) findViewById(R.id.partsdealerlist);
		...
		// SessionData.getInstance().getIndex(SessionData.getInstance().getProwcnt);
		...
		i = dealcount.getProwcnt(); /*
									 ...
									 */ 
		// pcount = dealcount.getProwcnt();
		// dealcount = SessionData.getInstance().getCindex(); 
		// pcount = dealcount.getProwcnt();
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent inspection = new Intent(RentalPartsOrderBranch.this,
	...
	public void onClick(View v) {
		...
		/*
		 * //} /*else{ new AsyncDealerBranchFiltter().execute(); }
		 */
	}
	...
	private class AsyncDealerBranch extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			ProgressBar.showCommonProgressDialog(RentalPartsOrderBranch.this);
			ProgressBar.showCommonProgressDialog(RentalPartsOrderBranch.this);
			...
			if(dealer.size()==0){
				...
				if(dealer.get(0).getMessage().equals("")){
					...
					if(dealer.get(0).getMessage().contains("Session")){
						...
						dialog = new Dialog(RentalPartsOrderBranch.this);
...
//				requestWindowFeature(Window.FEATURE_NO_TITLE);
				...
				ProgressBar.dismiss();
				AlertDialogBox.showAlertDialog(RentalPartsOrderBranch.this,
						"Data is not found");
			}
	...
	public void onBackPressed() {
		...
		super.onBackPressed();
		Intent intent = new Intent(RentalPartsOrderBranch.this, EbsMenu.class);
